    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header"style="background:#f46f22;color:white">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="fw-bold   font-weight-bold">Admin Change Password Page Section</h5>
                    </div>
                    <div class="col-md-6">
                        <div class="row ">
                            ...
                            <div class="col-md-3 col-sm-12 text-center">
                                <a href="{{ route('show.staff') }}" class="btn btn-info float-end  mx-auto" >
                                    Admin List
                                </a>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form method="post" action="{{url('admin/update-user-password')}}" enctype="multipart/form-data" id="update-password-form">
                            @csrf
                            <input type="hidden" name="id" value="{{$select_staff_table->id}}" id="id">
                            <div class="form-group">
                                <label class="form-label"  for="">User Password <span class="text-danger"> : {{$select_staff_table->name}}</span></label>
