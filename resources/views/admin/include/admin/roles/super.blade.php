<li>
    ...
    <li>
        <a href="#bulk_order" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('Corporate Orders') }}</a>
        <ul class="collapse list-unstyled" id="bulk_order" data-parent="#accordion" >
               <li>
                <a href="{{route('admin-bulk_order-index')}}"> {{ __('All Corporate Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-bulk_order-pending')}}"> {{ __('Pending Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-bulk_order-processing')}}"> {{ __('Processing Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-bulk_order-completed')}}"> {{ __('Completed Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-bulk_order-declined')}}"> {{ __('Declined Orders') }}</a>
            </li>
    ...
    <li>
        <a href="{{ route('admin-writer-index') }}" class=" wave-effect"><i class="fas fa-user"></i>{{ __('Writer') }}</a>
    </li>


    <li>
        <a href="{{ route('admin-publisher-index') }}" class=" wave-effect"><i class="fas fa-book-open"></i>{{ __('Publisher') }}</a>
    </li>
    ...
    <li>
        <a href="{{ route('admin-sales_report-index') }}" class=" wave-effect"><i class="fas fa-user-secret"></i>{{ __('Sales Report') }}</a>
    </li>
    <li>
